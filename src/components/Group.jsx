    ...
    <>
      <button className='mt-1 transition duration-150 ease-in-out' onClick={handleOpen}>
        ...
        <div className='flex justify-start border-r-2'>
          <button style={{borderRadius: `5px`, color: `#ffffff`, fontSize: `initial`, background: `darkslategray`}} className='text-[11px] font-normal tracking-wide flex items-center gap-x-1 bg-[#f6f6f6] text-[#1f2228] py-1 -mb-7 mt-2  px-2'>New Group <BsPlusLg /></button>
        </div>
      </button>
      <Modal
        open={open}
