...
setGaluak(user)   
  ...
  // useEffect(() => {
  //   if (galuak.organization === "inactive" ) {
  //     navigate("/adminhome");
  //   }
  // }, [galuak]);
    ...
    {Object.keys(columns).map((column) => (
      <option key={column}>
        ...
        {/* Print Table */}
            ...
            <button type="button"style={{backgroundColor:"#4CAF50", border:"none",color:"white",padding:"10px 20px",textAlign:"center"
  ,textDecoration:"none",display:"inline-block",fontSize:"16px",margin:"4px 2px",cursor:"pointer",borderRadius:"10px"}}    onClick={handleAddEmp}>
    Add Organization
  </button>
        <div>
            ...
            <tr>
              ...
              {columns.address && (
                ...
                <th onClick={() => handleSort('daysLeft')}>
                  days Left
                  {sortField === 'daysLeft' && sortOrder === 'asc' && <FiChevronUp />}
          ...
          {displayedData && displayedData.map((item) => (
              <React.Fragment key={item._id}>
                ...
                <tr onClick={() => handleRowToggle(item._id)}>
                  ...
                  {columns.daysLeft && <td>{item.daysLeft}</td>}
                 ...
                 <td>
  <button onClick={()=> handleShow(item)} style={{backgroundColor:"#4CAF50", border:"none",color:"white",padding:"10px 20px",textAlign:"center"
  ,textDecoration:"none",display:"inline-block",fontSize:"16px",margin:"4px 2px",cursor:"pointer",borderRadius:"10px"}}>Action</button>
  </td>
  <td>

<Button  style={{backgroundColor:"#4CAF50", border:"none",color:"white",padding:"10px 20px",textAlign:"center"
  ,textDecoration:"none",display:"inline-block",fontSize:"16px",margin:"4px 2px",cursor:"pointer",borderRadius:"10px"}} onClick={() => handleUpdate(item)}>Privilage</Button>
</td>
                </tr>
...
<Modal
 ...
 <button class="btn btn-light"   onClick={() => handleShow(user)} ><i className="fa fa-plus"></i></button>
        ...
        >
          ...
          <form onSubmit={handleFormSubmit} className="element">
 ...
 value={mobile} onChange={handleMobile} required
  ...
  <Modal
        ...
        >
          ...
          <Modal.Body>
          <h5 class="modal-title" id="exampleModalLongTitle">{currentUser && currentUser[0] && currentUser[0].email}</h5>
          <div className="bounce-in-bck"><button onClick={()=> handleAddEmp1()}  class="btn-flip" data-back="Admin" data-front="Create"
  >Create Admin</button> &nbsp;&nbsp;&nbsp;
   <button  onClick={()=> handleviewadmin()}   class="btn-flip" data-back="Admin" data-front="View"
  >View Admin</button>&nbsp;&nbsp;&nbsp;
  <button class="btn-flip" data-back="Admin" data-front="Edit"> </button>&nbsp;&nbsp;&nbsp;
  <button class="btn-flip" data-back="Admin" data-front="Delete"></button>
  </div> 
